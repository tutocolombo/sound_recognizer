...
LITMODEL_CLASS = lit_models.BaseLitModel

api = wandb.Api()

DEFAULT_ENTITY = api.default_entity
DEFAULT_FROM_PROJECT = "sound-recognizer"
DEFAULT_TO_PROJECT = "sound-recognizer"
DEFAULT_STAGED_MODEL_NAME = "sound-recognizer"

PROD_STAGING_ROOT = PROJECT_ROOT / "sound_recognizer" / "artifacts"
